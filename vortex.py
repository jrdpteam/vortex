...
def colorful_help():
    print(Fore.YELLOW + "vortex v3.1    " + Fore.MAGENTA + "by JRDP Team 2024")
    print(Fore.CYAN + "\nUsage:")
...
def decrypt_file(file_path, password):
    ...
    decrypted_file_path = file_path[:-5]
    ...
    print(Fore.GREEN + f'File decrypted and saved as {decrypted_file_path}')
...
def main():
    parser = argparse.ArgumentParser(description=Fore.YELLOW + 'vortex v3.1    ' + Fore.MAGENTA + 'by JRDP Team 2019-2024\n' +
